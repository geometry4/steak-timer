...
export function Setup() {
    ...
    return (_jsxs("div", { style: s.page, children: [_jsxs("header", { style: s.header, children: [_jsx("button", { className: "glass-pill", style: s.backBtn, onClick: () => nav(-1), children: "\u2190" }), _jsxs("div", { style: { flex: 1 }, children: [_jsx("h2", { style: s.title, children: cut.name }), _jsx("p", { style: s.subtitle, children: cut.nameEn })] })] }), _jsxs("div", { style: s.scroll, children: [cut.presets.length > 1 && (_jsxs("section", { children: [_jsx("p", { className: "sec-label", children: "\u539A\u5EA6" }), _jsxs("div", { ref: segRef, className: "liquid-seg glass", style: { borderRadius: 14 }, children: [_jsx("div", { ref: indRef, className: "seg-indicator" }), cut.presets.map((p, i) => (_jsxs("button", { className: i === presetIdx ? 'active' : '', onClick: () => selectPreset(i), children: [p.thickness, "cm"] }, p.id)))] })] })), !cut.hideDoneness && (_jsxs("section", { children: [_jsx("p", { className: "sec-label", children: "\u719F\u5EA6" }), _jsx("div", { style: s.donenessRow, children: DONENESS_LIST.map(d => (_jsxs("button", { className: d === doneness ? 'glass' : 'glass-pill', style: {
                                        ...s.donenessBtn,
